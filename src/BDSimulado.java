...
public class BDSimulado {
    ...
    // questao 2.a   quase igual a minha prova
    ...
    // questao 2.b   igual a minha prova
    ...
    // questao 2.c   igual a minha prova
    ...
    //questao 2.d    quase igual a minha prova 
    ...
    public String gerarConta( String nomeCLiente){
    	...
    	ArrayList<Ligacao> a1= LIgacoesPorCliente(nomeCLiente);
    	...
    	for (int i = 0; i < a1.size(); i++) {
			...
			resultado = resultado + "Ligação " + (i+1) + ": "+
					a1.get(i).getDataEHoraDeInicio().format(formatador) + " - " + 
					a1.get(i).getNumDeTelDestino() + " - " + 
					a1.get(i).getCidadeDeDestino() + "/" +
					a1.get(i).getUFDeDestino() + " " +
					valor + "\n";
		}
